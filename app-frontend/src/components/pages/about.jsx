      ...
      <div className="container">
        <section className="about-first-section">
          ...
          <div className="text-center" data-aos="fade-down">
            ...
            <p>
              ...
              <br />
              <br />
              Rupakot Resort is a beautiful resort set on 25 acres of space on
              the hill of the Rupa mountain in Pokhara, Kaski, nearly a
              45-minute drive away from Lakeside Pokhara and Pokhara national
              airport. At the resort, you can enjoy the splendid views of the
              Begnas, Rupa, and Fewa lake. It’s a haven where your room will
              seem woven subtly into the landscape directly connecting to the
              Annapurna Himalaya range. A place where you’ll enjoy a true sense
              of space and uninterrupted views of the serene lakes from your
              private spacious veranda. Giving the taste of Nepali rural life,
              this is a luxury resort where you’ll discover an outstanding level
              of service with ultimate comfort.
            </p>
          </div>
          ...
          <div className="about-atmosphere">
            <section className="atmosphere-desc" data-aos="fade-right">
              ...
              <p>
                ...
                ac tortor at tellus feugiat congue quis ut nunc. Semper ac dolor
                vitae accumsan. interdum hendrerit lacinia. Semper ac dolor
                vitae accumsan.
              </p>
            </section>
        ...
        <section className="about-second-section">
          <section className="video-content">
            ...
            <p>
              ...
              quod laudantium quidem adipisci ab temporibus maxime nostrum, at
              veniam quis magni ut explicabo? Quibusdam fugit corrupti assumenda
              quam error explicabo. Lorem ipsum dolor, sit amet consectetur
              adipisicing elit. Sunt pariatur nostrum assumenda, voluptate
              beatae enim consectetur qui cupiditate velit veritatis facere
              laboriosam iste ratione rem esse ut aliquid dolore officiis! Lorem
              ipsum dolor sit amet consectetur adipisicing elit. Cupiditate,
              iste libero. Dolores quam repellendus, blanditiis consequuntur
              harum quis illo sunt quasi necessitatibus facere repudiandae,
              architecto impedit distinctio eos itaque reprehenderit.
            </p>
          </section>
        </section>
        ...
        <section className="about-third-section" data-aos="fade-down">
          ...
          <p>
            ...
            tenetur harum nobis esse ex alias.
          </p>
