  ...
  return (<>
    <div className="banquetMenu-container">
      ...
      <section className="breakfast-section menu-section">
          ...
          breakfast.map((item, index) => {
            return (
              <div key={index}>
                ...
                <input type="text" id="breakfast" name="breakfast" placeholder="breakfast"
                  onChange={(e) => handleChange(e, index)} />

                <button className="menu-close-btn" name="breakfast"
        ...
        <button className="addMenu-btn" name="breakfast" onClick={(e) => {
          handleAddMenu(e);
        }}
      ...
      <section className="dinner-section  menu-section" >
          ...
          dinner.map((item, index) => {
            return (
              <div key={index}>
                ...
                <input type="text" id="dinner" name="dinner" placeholder="dinner"
                  onChange={(e) => handleChange(e, index)} />

                <button className="menu-close-btn" name="dinner"
                  onClick={(e) => { removeInput(e, index) }}>
                  X
                </button>
        ...
        <button className="addMenu-btn" name="dinner" onClick={(e) => { handleAddMenu(e); }}>Add Dinner</button>
      ...
      <section className="desert-section  menu-section">
        ...
        <label htmlFor="desert">Desert</label>
        {
          desert.map((item, index) => {
            return (
              <div key={index}>
                <input type="text" id="desert" name="desert" placeholder="desert"
                  onChange={(e) => handleChange(e, index)} />

                <button name="desert" className="menu-close-btn"
                  onClick={(e) => { removeInput(e, index) }}>
                  X
                </button>
        ...
        <button className="addMenu-btn" name="desert" onClick={(e) => { handleAddMenu(e); }}>Add Desert</button>
      </section>
      ...
      <section className="submit-menu-section">
        <button className="submit-menu" type="submit" onClick={() => { sendMenuData() }}>Submit</button>
      </section>
    </div>
  </>
  )
