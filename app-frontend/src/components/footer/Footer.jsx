...
import { AiFillMail, AiFillHome, AiFillInstagram, AiFillFacebook, AiOutlineWhatsApp } from 'react-icons/ai'
    ...
    <footer>
      <div className="footer-short-info">
        <div className="short-info-text" data-aos="zoom-in">
          <h2>Short Info</h2>
          <p>Get in Touch</p>
          <img src={"http://wahabali.com/work/pearl-demo/images/heading-dark.png"} alt="" />
        </div>
        <div className="get-touch" data-aos="zoom-in" >
          <section className="contact-us">
            ...
            <div className="footer-content">
              <p id="margin-btm">Lorem ipsum dolor sit amet, consectetur adipiscing elit Aenean ac.</p>
              <p><BsFillTelephoneForwardFill />  +977 982312132</p>
              <p><AiFillMail />  test@gmail.com</p>
              <p><AiFillHome />  329 Queensberry Street, North Me bourne, Australia.</p>
            </div>
          </section>
        ...
        <div className="links-newsletter">
          <div className="social-links">
            ...
            <div className="social-link">
              <a href="www.instagram.com"> <AiFillInstagram className="social-icon" /></a>
              <a href="www.instagram.com"> <AiFillFacebook className="social-icon" /></a>
              <a href="www.instagram.com"> <AiOutlineWhatsApp className="social-icon" /></a>
            </div>
          </div>
          <div className="newsLetter">
            ...
            <div className="form">
              <input className="email" id="email" placeholder="Enter your e-mail address" />
            </div>
          </div>
        </div>
      </div>
